...
public class GlobalExceptionHandler {
     ...
     * Produces a JSON-style body with {@link ResponseKeys#STATUS}, {@link ResponseKeys#MESSAGE}, and
     * {@link ResponseKeys#TIMESTAMP}; the message is taken from the exception, or {@code "Invalid request"}
     * when absent. Messages containing {@code "Decryption failed"} are surfaced as-is for RSA/decrypt failures.
     *
     * @param ex the runtime exception that was not handled by a more specific handler
     * @return {@link ResponseEntity} with HTTP {@code 400} and the error map in the body
     */
